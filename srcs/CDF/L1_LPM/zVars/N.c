...
#define FILLVAL      0                          //データが欠損しているところに入れる値
#define VALIDMIN     0                          //データの最小値
#define VALIDMAX     9999                       //データの最大値
#define CATDESC      "N"                        //変数の説明
