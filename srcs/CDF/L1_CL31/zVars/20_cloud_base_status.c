 ...
 * CDF Library
 *
 *  Ceilometer L1 zVariable cloud_base_status [UINT1][5]
 *
...
#define varName cloud_base_status
...
// **********************************************
  ...
  #define VALIDMIN       0
  #define VALIDMAX       5
  #define CATDESC      "Number of cloud base detected"
  #define FIELDNAM     TSTR(varName)
  #define VAR_TYPE     "data"
  #define VAR_NOTES    "Detection status"
//#define DICT_KEY     "."
//#define MONOTON      "."
//#define UNITS        "."
//#define UNIT_PTR     "."
