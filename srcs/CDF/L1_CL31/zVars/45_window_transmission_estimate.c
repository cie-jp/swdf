 ...
 * CDF Library
 *
 *  Ceilometer L1 zVariable window_transmission_estimate [UINT1]
 *
...
#define varName window_transmission_estimate
...
// **********************************************
  ...
  #define VALIDMIN       0
  #define VALIDMAX     100
  #define CATDESC      "Window transmission estimate"
  #define FIELDNAM     TSTR(varName)
  #define VAR_TYPE     "data"
  #define VAR_NOTES    "Window transmission estimate % (0...100)"
//#define DICT_KEY     "."
//#define MONOTON      "."
//#define UNITS        "."
//#define UNIT_PTR     "."
