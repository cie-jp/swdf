 ...
 * CDF Library
 *
 *  Ceilometer L1 zVariable laser_pulse_energy [UINT2]
 *
...
#define varName laser_pulse_energy
...
// **********************************************
  ...
  #define VALIDMIN       0
  #define VALIDMAX     999
  #define CATDESC      "Laser pulse energy"
  #define FIELDNAM     TSTR(varName)
  #define VAR_TYPE     "data"
  #define VAR_NOTES    "Laser pulse energy, % of nominal factory setting (0...999)"
//#define DICT_KEY     "."
//#define MONOTON      "."
//#define UNITS        "."
//#define UNIT_PTR     "."
