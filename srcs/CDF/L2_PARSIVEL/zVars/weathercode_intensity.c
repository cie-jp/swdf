 ...
 * CDF操作関連ライブラリ
 *
 *    Parsivel共通 L1 z変数 weathercode_intensity [INT2型]
 *    天気コード(MENTAR/SPECI Table4678)
...
#define varName weathercode_intensity
#define varType INT2
...
#define VALIDMIN     -3
#define VALIDMAX     +3
#define CATDESC      "Weather code intensity (0 : NP | 1 : Light | 2 : Moderate | 3 : Heavy | -3 : Other)"
