 ...
 * CDF操作関連ライブラリ
 *
 *    Parsivel共通 L1 z変数 measurement_start_time [TIME_TT2000型]
 *    観測開始時間
...
#define varName measurement_start_time
...
#define CATDESC      "Date/time measuring start"
...
//#define DEPEND_2     "."
//#define DEPEND_3     "."
#define FORMAT       "YYYY,MM,DD,hh,mm,ss,ww,yy,ii"
//#define FORM_PTR     "."
//#define DISPLAY_TYPE "."
//#define SCALECAP     "."
