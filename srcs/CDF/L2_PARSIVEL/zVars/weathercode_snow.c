 ...
 * CDF操作関連ライブラリ
 *
 *    Parsivel共通 L1 z変数 weathercode_snow [INT2型]
 *    天気コード(SYNOP Table4677)
...
#define varName weathercode_snow
#define varType INT2
...
#define VALIDMIN     -3
#define VALIDMAX     +3
#define CATDESC      "Weather code snow (0 : NP | +1 : SN | +2 : SG | +3 : GR | -1 : RASN | -2 : GS | -3 : Other)"
