...
#define T__MATRIX_BIDIAG            JOINT(TYPE,__MATRIX_BIDIAG)

#define T__MATRIX_QR                JOINT(TYPE,__MATRIX_QR)

#define T__MATRIX_SVD_BASE          JOINT(TYPE,__MATRIX_SVD_BASE)
#define T__MATRIX_SVD               JOINT(TYPE,__MATRIX_SVD)
